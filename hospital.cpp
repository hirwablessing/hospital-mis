...
void menuDisplay()
{
    ...
    do
    {
        ...
        cout << "5. where <disease> \t\t\t\t: Find where disease exists" << endl;
        cout << "6. cases <location><disease> \t\t\t: Find cases of a disease in a location" << endl;
        cout << "7. cases <disease> \t\t\t\t: Find total cases of a given disease" << endl;
        cout << "8. help \t\t\t\t: Prints user manual" << endl;
        cout << "9. Exit \t\t\t\t: Exits the program" << endl;
